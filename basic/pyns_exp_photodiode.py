...
# -*- coding: utf-8 -*-
"""
This function runs simple basic tasks (ie. eye open & close, blink, gaze) and photocell alignment to properly configure EEG environment prior to running the actual experiment.
Run this file on PsychoPy.
